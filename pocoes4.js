(function () {
  ...
  function renderPocoes(uid, catalogo, obtidos, podeGer) {
    var el = document.querySelector('.divpocoes'); if (!el) return;

    // 1º–7º Ano: automáticas do catálogo
    // Avançadas: automáticas do catálogo + manuais do perfil (obtidos)
    var grupos = {};
    ...
    // Poções manuais do perfil (avançadas atribuídas + únicas de qualquer ano)
    ...
    ANOS.forEach(function(a, i) {
      ...
      // Botões de admin só aparecem na aba Avançadas
