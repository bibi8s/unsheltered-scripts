...
{ id:'passar', nome:'Passar', desc:'Passa a Goles para o parceiro. +2 no arremesso.', alvos:'art_aliados' },
  ...
  apanhador:[
    { id:'rastrear', nome:'Rastrear', desc:'Acumula +1 de bônus para captura do Pomo. (turno de caça)' },
    { id:'sabotar', nome:'Sabotar', desc:'Zera o rastreamento do Apanhador adversário. (turno de caça)' },
    { id:'distracao', nome:'Distração', desc:'Adversário perde a fase sem acumular rastreamento. (turno de caça)' },
    { id:'auxiliar', nome:'Auxiliar', desc:'Passa a Goles para um Artilheiro aliado (+2).', alvos:'art_aliados' },
    { id:'mergulho_pomo', nome:'Mergulho pelo Pomo', desc:'Captura antecipada. Perdendo: -2 rastreamento. (turno de caça)' },
    { id:'carregar', nome:'Carregar', desc:'Derruba o Apanhador adversário e zera o rastreio dele. (turno de caça)' },
    { id:'inspirar', nome:'Inspirar', desc:'Dá +2 de bônus pra um aliado que ainda não agiu nesta fase.', alvos:'aliados' },
    { id:'provocar', nome:'Provocar', desc:'Aplica -2 num adversário por 1 fase, sem precisar rolar.', alvos:'adversarios' }
  ]
};
 ...
 var advTimeItem = item.time === 'A' ? 'B' : 'A';
      ...
      lista.forEach(function(a){
        ...
        html += '<button type="button" class="q3acaobtn" data-sk="' + sk + '" data-acao="' + a.id + '" data-alvos="' + (a.alvos || '') + '"' +
          (bloqueado ? ' disabled' : '') + titleBloqueio + '>' + a.nome + (bloqueado ? ' 🔒' : '') + '</button>';
      });
      html += '</div>';
