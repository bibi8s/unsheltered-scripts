(function () {
  ...
  function abrirModalRitual(dados) {
    ...
    var tag = dados._unico
      ? '<span class="ritual-tag ritual-tag-unica">Única</span>'
      : '<span class="ritual-tag ritual-tag-catalogo">Catálogo</span>';
  ...
  function renderRituais(uid, catalogo, obtidos, podeGer) {
    ...
    var btnAdd = podeGer
      ? '<div class="ritual-add-wrap">' +
          '<button class="ritual-btn-add" id="ritual-btn-abrir-sel"><i class="ph ph-plus"></i> Do catálogo</button>' +
