      ...
      if (podeGer) {
        ...
        html +=
          '<div class="feit-ano-item">' +
            '<button class="feit-ano-btn' + (liberado ? ' feit-ano-liberado' : ' feit-ano-bloqueado') + '" ' +
              'onclick="window._feitAbrirModalAno(' + (i+1) + ')" ' +
              'title="' + ano + '">' +
              label +
            '</button>' +
            '<button class="feit-ano-toggle" onclick="window._feitToggleAno(\'' + uid + '\',' + (i+1) + ',' + liberado + ')" ' +
              'title="' + (liberado ? 'Bloquear ano' : 'Liberar ano') + '">' +
        ...
        html +=
          '<button class="feit-ano-btn' + (liberado ? ' feit-ano-liberado' : ' feit-ano-bloqueado') + '" ' +
            (liberado ? 'onclick="window._feitAbrirModalAno(' + (i+1) + ')"' : 'disabled') +
            ' title="' + ano + (liberado ? '' : ' — bloqueado') + '">' +
            label +
          '</button>';
      }
    });
